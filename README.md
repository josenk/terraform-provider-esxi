...
* resource "esxi_virtual_disk"
  * virtual_disk_disk_store - Required - Disk Store.
...
* resource "esxi_guest"
  ...
  * guest_net_timeout - Optional - The amount of guest uptime, in seconds, to wait for an available IP address on this virtual machine.
  ...
  * virtual_disks - Array of virtual disks to add.
